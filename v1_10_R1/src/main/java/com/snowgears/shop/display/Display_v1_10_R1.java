...
public class Display_v1_10_R1 extends AbstractDisplay {

    public Display_v1_10_R1(Location shopSignLocation) {
    ...
    protected void spawnItemPacket(Player player, ItemStack is, Location location) {
        ...
        net.minecraft.server.v1_10_R1.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(is);
