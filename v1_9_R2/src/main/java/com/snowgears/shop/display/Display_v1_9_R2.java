...
public class Display_v1_9_R2 extends AbstractDisplay {

    public Display_v1_9_R2(Location shopSignLocation) {
    ...
    protected void spawnItemPacket(Player player, ItemStack is, Location location) {
        ...
        net.minecraft.server.v1_9_R2.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(is);
